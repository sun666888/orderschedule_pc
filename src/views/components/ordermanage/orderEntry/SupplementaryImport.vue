            ...
            <div class="row list-search">
                ...
                <div class="search-field col-md-12">
                    ...
                    <div class="download-file">
                        <a href="/orderschedule/index.php/Home/AuditDetails/template" class="download" download>点击下载</a>
                    </div>
                </div>
    ...
    methods: {
        ...
        confirmCreate() {
            ...
            if ( !!this.formfile.raw) {
                ...
                orderSrv.uploadOrder(formData).then(resp => {
                    loading.close();
                    this.$message.success("订单录入成功!");
                    this.$router.push("/ordermanage/UploadOrder");
                }, err => {
                    loading.close();
